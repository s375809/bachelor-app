...
interface WeeklyTimeTableProps {
  ...
  cases: Case[]
  unconfirmedSuggestions: UnconfirmedSuggestion[]
...
export function WeeklyTimeTable({
  ...
  const weekStart = startOfWeek(selectedDate, { weekStartsOn: 1 }) // Starter på mandag
      ...
      <div className="space-y-2">
        {entries.map((entry, index) => (
          ...
          >
            ...
            {entry.fromSuggestion && <div className="text-xs mt-1 italic">Fra forslag</div>}
          </div>
        ))}
      </div>
    )
        ...
        <table className="w-full min-w-[800px] border-collapse">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="p-3 text-left font-bold text-gray-700 uppercase text-sm">SAK</th>
              {weekDays.map((day, i) => (
                <th key={i} className="p-3 text-center font-bold text-gray-700 uppercase text-sm min-w-[120px]">
                  <div>{day.dayName}</div>
            ...
            {cases.map((caseItem) => (
              <tr key={caseItem.id} className="border-b border-gray-200 hover:bg-gray-50">
                <td className="p-3">
                  ...
                  <div className="text-sm text-gray-600">{caseItem.description}</div>
                </td>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3">
                  <Select
                    ...
                    onValueChange={(value) => setEditingEntry({ ...editingEntry, caseId: value })}
                  >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3">
                  <Select
                    ...
                    onValueChange={(value) => setEditingEntry({ ...editingEntry, activityType: value })}
                  >
                    <SelectTrigger className="w-full">
          ...
          <DialogFooter className="flex justify-between">
            <Button variant="destructive" onClick={handleDeleteEdit} className="mr-auto">
