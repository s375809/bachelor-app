...
import { FileText, MessagesSquare, SearchIcon, Trash2, CheckCircle2, FileEdit } from "lucide-react"
...
interface UnconfirmedSuggestionsProps {
  suggestions: UnconfirmedSuggestion[]
  onConfirm: (suggestionId: string) => void
  onDelete: (suggestionId: string) => void
  onUpdate: (suggestion: UnconfirmedSuggestion) => void
  cases: Case[]
}
...
export function UnconfirmedSuggestions({
  ...
  const [editingSuggestion, setEditingSuggestion] = useState<UnconfirmedSuggestion | null>(null)
        ...
        {suggestions.length === 0 ? (
          ...
          suggestions.map((suggestion) => (
            ...
            >
              ...
              >
                {React.createElement(getIconComponent(suggestion.type), { className: "w-5 h-5 flex-shrink-0" })}
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                    <div>
                      ...
                      <div className="text-sm font-medium text-gray-600">{suggestion.description}</div>
                    </div>
                    <div className="text-lg font-bold">{suggestion.hours.toFixed(2)}t</div>
                  </div>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 font-medium">
                  {format(editingSuggestion.date, "d. MMMM yyyy", { locale: nb })}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3">
                  <Select
                    ...
                    onValueChange={(value) => setEditingSuggestion({ ...editingSuggestion, caseId: value })}
                  >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <label htmlFor="edit-activity" className="text-right font-medium">
                  Aktivitet
                </label>
                <div className="col-span-3">
                  <Select
                    value={editingSuggestion.type}
                    onValueChange={(value) => setEditingSuggestion({ ...editingSuggestion, type: value })}
                  >
                    <SelectTrigger className="w-full">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (!isNaN(val)) {
                      setEditingSuggestion({ ...editingSuggestion, hours: val })
                    }
                  }}
                  className="col-span-3"
                />
